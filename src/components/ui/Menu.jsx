  ...
  return (
    <div ref={wrapRef} className="relative inline-flex">
      <button
        ...
        aria-label={label}
        onClick={toggle}
        className={`inline-flex min-h-9 min-w-9 items-center justify-center rounded-md p-1.5 transition 2xl:min-h-0 2xl:min-w-0 ${open ? 'bg-raise text-ink' : 'text-faint hover:bg-raise hover:text-ink'}`}
      >
