      ...
      <div className={`bom-pop-in my-auto w-full ${maxWidth} rounded-xl bg-surface shadow-xl shadow-black/15 ring-1 ring-line`}>
        <div className="flex items-start gap-3 border-b border-line2 px-6 py-4">
          ...
          <button
            ...
            disabled={!closable}
            className="inline-flex min-h-9 min-w-9 shrink-0 items-center justify-center rounded-lg p-1.5 text-faint transition hover:bg-raise hover:text-ink disabled:opacity-40 2xl:min-h-0 2xl:min-w-0"
            aria-label="Close"
          >
            <IconClose />
          </button>
